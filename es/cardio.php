...
<body>
  <header class="header" id="cielo">
    <h2 class="header-title">Cardio</h2>
  </header>
  <?php include '../sent/nav.php'?>
      <main class="main main-cardio">
        ...
        <figure class="figure cardiogif-container mt-2">
          ...
          <figcaption class="figure-caption w-50"> Para llevarlo a cabo solo debes llevar las rodillas lo más alto posible pasando la altura horizontal (de la pelvis) y alternar lo más rápido que se pueda la elevación de las piernas, coordinando brazo y pierna contrarios. Mientras se realizan los movimientos anteriores, el tronco debe mantenerse recto y la zona media contraída, para evitar lesiones.</figcaption>
        </figure>
        ...
        <figure class="figure cardiogif-container mt-2">
          ...
          <figcaption class="figure-caption w-50">Párese de pie con los pies separados a la altura de los hombros y mirando hacia adelante. Comience a patear sus pies hacia arriba, hasta que los talones toquen los glúteos, y bombee sus brazos al mismo tiempo. </figcaption>
        </figure>
        <p class="mx-auto texto-cardio">Cuando estás de viaje y no tienes tiempo de ir hasta el gimnasio o prefieres el aire libre, la recomendación es caminar, trotar y pedalear en tu bicicleta.<br><br>
        </p>
        <figure class="figure cardiogif-container mt-2">
          <img src="../media/cardio gif/lateral shuffle taps.gif" class="w-50 ml-5 gif-cardio figure-img img-fluid rounded">
          <figcaption class="figure-caption w-50">Párese sobre una pierna con una ligera inclinación en la rodilla y con la otra pierna levantada del piso. Salte lateralmente, cayendo con el pie contrario.  Haga una pausa y luego salte una vez hacia arriba antes de rebotar de nuevo a la posición inicial.</figcaption>
        </figure>
        <p class="mx-auto texto-cardio">
          ...
          <figure class="figure cardiogif-container mt-1">
            <img src="../media/cardio gif/burpees.gif" class="w-50 ml-5 gif-cardio figure-img img-fluid rounded">
            <figcaption class="figure-caption w-50 ml-5">Para realizar el ejercicio de burpees se parte de una posición inicial en cuclillas, se colocan las manos en el suelo y se mantiene la cabeza erguida.
          ...
          <figure class="figure cardiogif-container mt-1">
            <img src="../media/cardio gif/jumping jacks.gif" class="w-50 ml-5 gif-cardio figure-img img-fluid rounded">
            <figcaption class="figure-caption w-50 ml-5 texto-final-cardio">Primero, sitúate de pie con los pies juntos y los brazos extendidos a lo largo del cuerpo. Luego, salta con las piernas y los pies a los lados, mientras levantas los brazos por encima de la cabeza. Posteriormente, sin hacer una pausa, debes volver a la posición inicial bajando los brazos y saltando para volver a estar juntos. Debes asegurarte de mantener las rodillas relajadas y de flexionarlas un poco mientras aterrizas. Esto hará que evites lesiones por el impacto repetitivo.</figcaption>
          </figure>
